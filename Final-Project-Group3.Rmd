...
---
# Package Details
Our package is uploaded to GitHub publicly and is available for download in the AU-R-Programming repository with our repo being named  <br />  Final-Project-Group3.
<br />
<br />
You can directly download the package with devtools installed using:
<br />
<br />
devtools::install_github('AU-R-Programming/Final-Project-Group3/Group3Package/FinalProjPackage')
<br />
<br />
Help documentation is available for each function after the package is installed via:
<br />
<br />
?coeff_beta
<br />
...
<br />
<br />
All functions in the R-Markdown file contain their description used for package creation/help documentation, and below the function is a call to it showing an example output using the USAressts data set. 
...
# For Comparing Some Of Our Values To True Values
